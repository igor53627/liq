...
contract HighMemTest is Test {
    ...
    function testHighMem() public {
        ...
        // Use memory starting at 0x100 (well above Solidity's area)
        assembly {
        ...
        uint256 bal;
        assembly { bal := mload(0x200) }
        console.log("Balance from high mem:", bal);
    }
}
